  ...
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.FOR_BIDDEN:
        return Failure(ResponseCode.FOR_BIDDEN, ResponseMessage.FOR_BIDDEN);
...
class ResponseCode {
  ...
  static const int FOR_BIDDEN = 403; //  failure, API rejected request
...
class ResponseMessage {
  ...
  static const String FOR_BIDDEN =
